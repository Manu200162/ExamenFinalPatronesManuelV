...
public class SistemaUniversidad implements ISistemasDeControlInscripcion{
    ...
    public SistemaUniversidad(IRedsocial redsocial, String nombre, int capacidad, List<Estudiante> listEstudiantes, String requisitos) {
    ...
    public void informacion() {
        ...
        System.out.println("Capacidad de la universidad: "+capacidad+" Estudiantes");
